...
public class EBCDIC {
	...
	static {
		...
		// Without this, the loop above maps '|' to 0x6A (Broken Bar) if 0x6A was mapped
		// to '|',
		...
		//EBCDIC_TO_APL[0xAD] = '┌';           // Should be Left Bracket
		EBCDIC_TO_APL[0xAD] = '['; 
		EBCDIC_TO_APL[0xC5] = '┌';
		EBCDIC_TO_APL[0xAE] = '┐';
		EBCDIC_TO_APL[0xD5] = '┐';
		//EBCDIC_TO_APL[0xBD] = '└';            // Should be Right Bracket
		EBCDIC_TO_APL[0xBD] = ']'; 
		EBCDIC_TO_APL[0xC4] = '└';
		EBCDIC_TO_APL[0xBE] = '┘';
		EBCDIC_TO_APL[0xD4] = '┘';
