...
import static com.tn3270.constants.ProtocolConstants.AID_ATTN;
...
import static com.tn3270.constants.ProtocolConstants.AID_PF2;
import static com.tn3270.constants.ProtocolConstants.AID_PF3;
import static com.tn3270.constants.ProtocolConstants.AID_PF4;
import static com.tn3270.constants.ProtocolConstants.AID_PF5;
import static com.tn3270.constants.ProtocolConstants.AID_PF6;
import static com.tn3270.constants.ProtocolConstants.AID_PF7;
import static com.tn3270.constants.ProtocolConstants.AID_PF8;
...
import static com.tn3270.constants.ProtocolConstants.AID_PF14;
import static com.tn3270.constants.ProtocolConstants.AID_PF15;
import static com.tn3270.constants.ProtocolConstants.AID_PF16;
import static com.tn3270.constants.ProtocolConstants.AID_PF17;
import static com.tn3270.constants.ProtocolConstants.AID_PF18;
...
import static com.tn3270.constants.ProtocolConstants.AID_PF21;
...
import static com.tn3270.constants.ProtocolConstants.AID_SYSREQ;
...
public class KeyboardSettingsDialog extends JDialog {
	...
	private static final int[] PF_AID_ARRAY = new int[] { AID_PF1, AID_PF2, AID_PF3, AID_PF4, AID_PF5, AID_PF6, AID_PF7,
	...
	private JScrollPane create3270Panel() {
		...
		int row4Y = y;
		x = START_X;
		add3270Button(panel3270, "Tab", 0, x, y, (int) (KW * 1.5), KH);
		x += (int) (KW * 1.5) + GAP;
	...
	private JScrollPane createPCPanel() {
		...
		JLabel help = new JLabel(
				"<html><b>Visual PC Keyboard:</b> Click a character to translate it.<br>Example: Toggle Shift, Click '^', Select '¬'.</html>");
	...
	private void add3270CharButton(JPanel p, String normal, String shifted, int x, int y, int w, int h) {
		...
		btn.addActionListener(e -> {
			...
			KeyCaptureDialog cap = new KeyCaptureDialog(this,
					"Press desired physical key to act as '" + currentLbl + "' key", false);
			cap.setVisible(true);
			if (cap.cleared) {
		...
		btn.addActionListener(e -> {
			...
			if (cap.cleared) {
				...
				if (label.equals("RESET"))
					newMap = new KeyMapping(0, "RESET");
				else if (label.equals("EraseEOF"))
					newMap = new KeyMapping(0, "EraseEOF");
				else if (label.equals("NEWLINE") || label.equals("R-Shift"))
					newMap = new KeyMapping(AID_ENTER, "NEWLINE");
				else if (label.equals("Back"))
					newMap = new KeyMapping(0, "BACKSPACE");
				else if (label.equals("Tab"))
					newMap = new KeyMapping(0, "TAB");
				else
					newMap = new KeyMapping(aidCode, label);
	...
	private void addPCCharButton(JPanel p, String normal, String shifted, int x, int y, int w, int h) {
		...
		btn.addActionListener(e -> {
			...
			if (tempCharMap.containsKey(inputChar)) {
				if (JOptionPane.showConfirmDialog(this, "Clear translation for '" + inputChar + "'?", "Clear Rule",
						JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
	...
	private void removeMappingsForFunction(String label, int aid) {
		...
		tempKeyMap.entrySet().removeIf(entry -> {
			...
			if (km.aid != null && km.aid.intValue() == aid && aid != 0)
				return true;
			return false;
		});
	}
	...
	class SpecialCharPalette extends JDialog {
		...
		public SpecialCharPalette(Dialog owner) {
			...
			hexBtn.addActionListener(e -> {
				String input = JOptionPane.showInputDialog(this, "Enter 4-digit Hex Code (e.g. 00AC):", "Hex Input",
